const AboutUsSection = () => {
    return <div>
        ...
        <ul>
            ...
            <li>Desarrollar herramientas para mejores representaciones: proveer recursos a guionistas, productores y creadores de contenido que les ayuden a construir personajes y narrativas LGBTIQA+ de manera responsable y genuina.</li>
        ...
        En resumen, creemos que una representación auténtica y variada en la ficción puede no solo cambiar la percepción de la audiencia, sino también inspirar a nuevas generaciones a ser quienes realmente son, con orgullo y sin miedo; al fin y al cabo, somos aquello que vemos que podemos ser.

        <h4>Bienvenidxs a Cine Diverso 🌈❤️</h4>
    </div>
}
